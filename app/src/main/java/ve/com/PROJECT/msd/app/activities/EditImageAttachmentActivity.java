...
import ve.com.PROJECT.msd.app.dialogs.SelectImageSourceDialogFragment;
import ve.com.PROJECT.msd.enums.ImageSourceType;
import ve.com.PROJECT.msd.enums.TapTargetSequenceType;
import ve.com.PROJECT.msd.model.attachment.ImageAttachment;
import ve.com.PROJECT.msd.util.FileUtil;
import ve.com.PROJECT.msd.util.ImageUtil;
import ve.com.PROJECT.msd.util.PermissionUtil;
import ve.com.PROJECT.msd.util.SnackbarUtil;
import ve.com.PROJECT.msd.util.TapTargetSequenceUtil;
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            case R.id.activity_edit_image_attachment_crop:
                applyPendingRotation();
                File imageFile = new File(FileUtil.getImageAttachmentDir(this), mImageAttachment.getImageFilename());
                Uri imageUri = FileProvider.getUriForFile(this, "ve.com.project.msd.fileprovider", imageFile);
    ...
    private void dispatchTakePictureIntent() {
        ...
        if (takePictureIntent.resolveActivity(this.getPackageManager()) != null) {
            ...
            if(imageAttachmentFile != null) {
                try {
                    imageUri = FileProvider.getUriForFile(this, "ve.com.project.msd.fileprovider", imageAttachmentFile);
