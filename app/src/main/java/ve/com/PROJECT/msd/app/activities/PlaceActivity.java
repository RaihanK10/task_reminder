package ve.com.PROJECT.msd.app.activities;
...
import ve.com.PROJECT.msd.app.dialogs.EditPlaceDialogFragment;
import ve.com.PROJECT.msd.app.services.AddressResultReceiver;
import ve.com.PROJECT.msd.app.services.FetchAddressIntentService;
import ve.com.PROJECT.msd.database.RemindyDAO;
import ve.com.PROJECT.msd.exception.CouldNotDeleteDataException;
import ve.com.PROJECT.msd.exception.CouldNotGetDataException;
import ve.com.PROJECT.msd.exception.CouldNotInsertDataException;
...
import ve.com.PROJECT.msd.util.SnackbarUtil;
...
//        getWindow().requestFeature(Window.FEATURE_CONTENT_TRANSITIONS);
        ...
        mAutocompleteFragment = (AutocompleteSupportFragment) getSupportFragmentManager().findFragmentById(R.id.activity_place_autocomplete_fragment);
       // mAutocompleteFragment.setPlaceFields(Arrays.asList(Place.Field.ID, Place.Field.NAME));
        //mAutocompleteFragmentsetPlaceFields(Arrays.asList(com.google.android.gms.location.places.Place.TYPE_STREET_ADDRESS.ADDRESS, Place.Field.LAT_LNG));
        if (!com.google.android.libraries.places.api.Places.isInitialized()) {
            com.google.android.libraries.places.api.Places.initialize(getApplicationContext(), "AIzaSyD68JlexiX5CvFJ4xzw9WC92gRzJha05dk");
        }

        // Create a new Places client instance.
       placesClient = com.google.android.libraries.places.api.Places.createClient(this);
        mAutocompleteFragment.setTypeFilter(TypeFilter.CITIES);
        mAutocompleteFragment.setPlaceFields(
        ...
        mAutocompleteFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onError(@NonNull Status status) {
                Log.e("TAGMAP", "onError: "+status.getStatus() );
    ...
    private void moveCameraToLastKnownLocation() {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            ...
            if (lastLocation != null) {
                Log.e("TAGMAP", "moveCameraToLastKnownLocation: " );
                Log.e("TAGMAP", "move camera: " +lastLocation.getLatitude()+"...."+lastLocation.getLongitude());
    ...
    private void handleSaveOrUpdatePlace() {
        ...
        if(mPlaceToEdit != null) {
            try {
                ...
                Log.e("TAGMAP", "handleSaveOrUpdatePlace: "+e.getMessage());
