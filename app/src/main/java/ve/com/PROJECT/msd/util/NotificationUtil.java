...
import ve.com.PROJECT.msd.app.Constants;
import ve.com.PROJECT.msd.app.activities.HomeActivity;
import ve.com.PROJECT.msd.app.activities.TaskDetailActivity;
import ve.com.PROJECT.msd.app.services.TaskActionsIntentService;
import ve.com.PROJECT.msd.model.Task;

import static android.content.Context.NOTIFICATION_SERVICE;
import static ve.com.PROJECT.msd.app.activities.TaskDetailActivity.TASK_ID_TO_DISPLAY;


public class NotificationUtil {

    public static void displayNotification(Context context, Task task, String contentTitle, String contentText) {
        Log.e("TAG", "ondisplaynotif: notification showing" );
        ...
        //setTaskDoneIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        ...
        openTaskIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        ...
        assert mNotifyMgr != null;
        mNotifyMgr.notify(task.getId()/* Request Code */, mBuilder.build());
    ...
    public static void displayLocationBasedNotification(Context context, int notificationId, String contentTitle, String contentText,
        ...
        assert mNotifyMgr != null;
        mNotifyMgr.notify(triggeredTasks.get(0).getId()/* Request Code */, mBuilder.build());
        // Builds the notification and issues it.
